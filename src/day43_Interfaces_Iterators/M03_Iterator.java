...
public class M03_Iterator {
    public static void main(String[] args) {
        ...
        System.out.println(liste); // liste = [10, 20, 30]
        ...
        Adim adim sona ulastiktan sonra basa gelen isterseniz yeniden bir iterator
        ...
        it2.next(); // 10
        it2.remove(); // 10'u siler
        System.out.println(liste); // [20, 30]
        it2.next(); // 20
        it2.remove(); // 20'yi siler
        it2.next(); // 30
        it2.remove(); // 30'u siler
