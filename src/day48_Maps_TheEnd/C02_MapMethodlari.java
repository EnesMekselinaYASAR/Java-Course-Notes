...
public class C02_MapMethodlari {
    public static void main(String[] args) {
        ...
        System.out.println(sinifListMap.getOrDefault(104, "aradiginiz key bulunamadi"));
        // Derya, Deniz, Devops

        System.out.println(sinifListMap.getOrDefault(110, "aradiginiz key bulunamadi"));
        // aradiginiz key bulunamadi
        ...
        map.putIfAbsent(key, value) ==> key varsa ekleme yapmaz, bıze o key ile kayitli olan
        value'yu getirir.
