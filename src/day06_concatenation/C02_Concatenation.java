...
public class C02_Concatenation {
    public static void main(String[] args) {
        ...
        System.out.println(5 * 2 != 15); // eşit değildir de mi, eşit değil çıkarsa true cevabını verir.
        System.out.println(5 + 2 != 7); // Eşit değildir de mi, eşit çıkarsa false cevabını verir
