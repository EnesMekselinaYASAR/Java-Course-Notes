...
public class C01_InstanceVariables {
    ...
    public static void main(String[] args) {
        ...
        instance variables static olmadigi icin static klup'e uye main method'dan direk
        kullanamayiz.
        ...
        System.out.println("obje1 deggismeden once: "+obje1.instSayi); // 20
        obje1.instSayi=30;
    ...
    public static void staticMethod() {
        ...
        /*
        instSayi=30;
        Instance variable'lara main method dısındaki static method'lardan da
        direkt ulasamayız.
